...
for real, to the google play store

per http://ionicframework.com/docs/guide/publishing.html
...
----
mkdir keystore
$JAVA_HOME/bin/keytool -genkey -v -keystore keystore/my-release-key.keystore -alias alias_name -keyalg RSA -keysize 2048 -validity 10000
----

[source,bash]
----
$JAVA_HOME/bin/jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore keystore/my-release-key.keystore platforms/android/build/outputs/apk/android-release-unsigned.apk alias_name
----
...
$ANDROID_HOME/build-tools/23.0.2/zipalign -v 4 android-release-unsigned.apk ecp-contactapp.apk
----
