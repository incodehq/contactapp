 ...
 */
public class ContactApplication extends IsisWicketApplication {
    ...
    protected void init() {
        ...
        settings.setActiveThemeProvider(new ContactAppUserSettingsThemeProvider(settings));
    }
    ...
    protected Module newIsisWicketModule() {
        ...
        final Module overrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                //bind(String.class).annotatedWith(Names.named("brandLogoHeader")).toInstance("/images/contactapp-logo-header.png");
                //bind(String.class).annotatedWith(Names.named("brandLogoSignin")).toInstance("/images/contactapp-logo-signin.png");
