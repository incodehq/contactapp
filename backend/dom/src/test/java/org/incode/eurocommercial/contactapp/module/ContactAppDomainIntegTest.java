 ...
 *  under the License.
 */
package org.incode.eurocommercial.contactapp.module;
...
public abstract class ContactAppDomainIntegTest extends IntegrationTestAbstract3 {

    protected ContactAppDomainIntegTest() {
        super(new ContactAppDomainIntegTestModule());
    }
